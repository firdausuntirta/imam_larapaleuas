...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
      ...
      <div class="container-fluid">
        ...
        <h1 class="h3 mb-2 text-gray-800">Form Input Data Pengunjung</h1>
        <p  class="mb-4">
            Silahkan masukkan biodata pengunjung disini. Pastikan data yang dimasukkan valid dan tidak ada kesalahan!
        </p>
        
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Input Data Pengunjung</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('pengunjung.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="date" name="tanggalLahir" class="form-control" id="Tanggal Lahir" required>
                      </div>
