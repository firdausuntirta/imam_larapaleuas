...
<!-- Notifikasi menggunakan JavaScript Alert -->
@if (session('success'))
    <script>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <div class="container-fluid">
      <!-- Page Heading -->
      <h1 class="h3 mb-2 text-gray-800">Table Daftar Pengunjung</h1>
      <p class="mb-4">
      ...
      <!-- DataTales Pengunjung -->
      <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between">
          <h6 class="m-0 font-weight-bold text-primary">Daftar Pengunjung</h6>
          <a href="{{ route('pengunjung.create') }}" class="btn btn-sm btn-primary btn-icon-split">
            <span class="icon text-white-50">
              <i class="fas fa-plus"></i>
            </span>
            <span class="text">Insert Data Pengunjung</span>
          </a>
        </div>
        <div class="card-body">
                  ...
                  @foreach ($pengunjung as $no => $data)
                      <tr>
                          ...
                          <td class="d-flex justify-content-center">
                            <a href="{{ route('pengunjung.edit', $data->id) }}" class="btn btn-info btn-circle btn-sm">
                              <i class="fas fa-pen"></i>
                            </a>
                            <form action="{{ route('pengunjung.delete', $data->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini? \nID Pengunjung: {{ $data->id }}\nNama: {{ $data->nama }}');">
                              @csrf
                              @method('DELETE')
